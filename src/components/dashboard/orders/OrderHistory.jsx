...
const OrderHistory = () => {
  const { activationFilter } = useFilter();
  ...
  const handleToggle = async (patientId) => {
    ...
    if (isExpanded) {
      ...
      try {
        ...
        const res = await axios.get(`${API_BASE_URL}/order-history/`, {
          headers: {
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-500 dark:text-gray-400">
                    {patient.orders.length} {patient.orders.length === 1 ? 'order' : 'orders'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              ...
              {patient.orders.length >= 5 && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full mt-3 flex items-center justify-center gap-2 py-2 text-xs font-semibold text-teal-600 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/20 rounded-lg transition-colors"
                >
